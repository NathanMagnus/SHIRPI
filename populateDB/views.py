...
def populateMaster():
	...
	items = {
		'1': {'short_description': 'Improper storage of perishable foods', 
		...
		'5': {'short_description': 'Employee Hygiene',
		...
		'6': {'short_description': 'Potential Contamination',
			'description': 'Foods must be protected from contamination at all times.',
			'severity': 1
			},
		'7': {'short_description': 'Dish Washing Procedures',
		...
		'8': {'short_description': 'Food and Water Source',
		...
		'9': {'short_description': 'placeholder for 9', 
			'description': 'place holder for 9',
			'severity': 1
			},
		'10': {'short_description': 'Food Storage', 
		...
		'11': {'short_description': 'Thermometer Access',
		...
		'12': {'short_description': 'Dish Washing Facilities',
		...
		'13': {'short_description': 'Garbage Containers',
		...
		'14': {'short_description': 'Vermin',
			'description': 'All restaurants are to be free of vermin',
			'severity': 1
			},
		'15': {'short_description': 'Building Conditions',
		...
		'16': {'short_description': 'Building Conditions',
