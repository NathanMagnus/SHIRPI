...
def display_favourite( favourite, autoescape = None ):
	...
	result += "<h3 class='name'><a href=\"/cs215/shirpi/view/" + urlquote_plus(favourite.restaurant.name)+ "/" + urlquote_plus(favourite.restaurant.address) + "/\">" + str(favourite.restaurant.name) + "</a></h3>\n"
...
def display_favourite_edit( favourite, count ):
	...
	result += "<h4 class='delete'><a href=\"/cs215/shirpi/delete_favourite/" + urlquote_plus(favourite.restaurant.name) + "/" + urlquote_plus(favourite.restaurant.address) + "/\">Del</a></h4>\n"
