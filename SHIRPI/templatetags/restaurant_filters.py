...
def display_restaurant(value, autoescape=None):
	...
	result += "<li><h4>" + str(value.combined/value.combined_count) + "</h4></li>"
	result += "<li><h4>" + str(value.food_quality/value.food_quality_count) + "</h4></li>"
	result += "<li><h4>" + str(value.cleanliness/value.cleanliness_count) + "</h4></li>"
	result += "<li><h4>" + str(value.atmosphere/value.atmosphere_count) + "</h4></li>"
	result += "<li><h4>" + str(value.wait_time/value.wait_time_count) + "</h4></li>"
	result +="</ul>"
	result += "</div>"
