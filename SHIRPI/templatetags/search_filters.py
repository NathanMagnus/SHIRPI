...
def display_search_field( request ):
	...
	result += "<input type='text' name='restaurant_name' id='restaurant_name_field' size='19' value='" + name + "' " + \
		"onblur=\"if (this.value == '') this.value='Location Name';\" onfocus=\"if (this.value == 'Location Name') this.value='';\"/>\n"
	
	result += "<input type='text' name='restaurant_address' id='restaurant_address_field' size='18' value='" + address + "' " + \
	...
	result += "<span id='dropdown_divider'>to</span>\n"
