...
urlpatterns = patterns('',
    ...
    (r'^cs215/hello/browse/(?P<rest_name>[^/]+)/(?P<rest_address>[^/]+)/', 'project.hello.views.browse'),
    (r'^cs215/hello/comment/(?P<rest_name>[^/]+)/(?P<rest_address>[^/]+)/', 'project.hello.views.comment'),
    (r'^cs215/hello/save/(?P<rest_name>[^/]+)/(?P<rest_address>[^/]+)/', 'project.hello.views.save'),
